...
f = open(f'{outDataDir}/permutations/Rad21ICRF_R1R2R3_permuted_walks_with_summary_first6fragments.iter{iteration}.pkl', 'wb')
pickle.dump(walks_with_summary_firstx_length_fractions, f)
f.close()

f = open(f'{outDataDir}/permutations/Rad21ICRF_R1R2R3_permuted_walks_summarized_first6fragments.iter{iteration}.pkl', 'wb')
